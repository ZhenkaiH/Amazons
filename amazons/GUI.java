...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("AI->AI vs. AI", this::autoW);
        addMenuButton("Manual->Human vs. Human", this::manW);
